...
module base(){difference(){union(){
 ...
 for(p=[[-3.5,31],[-3.5,37],[63,16],[63,22],[63,30],[63,36]])translate([p[0],p[1],base_bottom-1])linear_extrude(5)hull(){translate([-.75,0])circle(r=.75);translate([.75,0])circle(r=.75);}
}}
