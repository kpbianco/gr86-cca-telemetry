# T01 thermal correction, bound to final I04
...
The formed packet descends outside the carrier's right edge and turns beneath it. `THERMAL_CONTACT_T01.scad` is its volume envelope, not a claim of a manufactured laminated solid. The landing is a2mm aluminium plate atX51..66.5,Y4..35.8,Z−15.327..−13.327mm, withM3 holes at(54,7.5)/(54,32.3). The heads are away from the foil and cable anchors. The bolt/washer/nut allowance increases the basic thermal assembly envelope to**108.454766×73×36.50mm**, before vehicle mating/tool/cable/airspace volumes. All original board captures remain required. The total mass screen is126g including thermal hardware and≤0.086g added slot reinforcement; the126g/20g one-ear flexural demand is122.58MPa versus the declared150MPa material requirement.

`GR86_RVB_CARRIER_C03_THERMAL.scad` removes auxiliary slotsY16/22. MECH22-31 places primary slotsX−4,Y31/37 and auxiliary slotsX62.5,Y33/39, using3.9×1.6mm nominal obrounds and local8mm reinforcement. The right insert startsY30, retaining1.2mm to the thermal packet'sY28.8 edge. The primary bundle/strap build is≤7.3mm; the right coax build remains≤2.8mm, with localized5.2×5.2×3.9mm heads. Route U.FL away from the strip toward−Y. The actual bundle may not cross the foil, sharp edges or ventilation windows. The unchanged strip source is verified byte-for-byte against its pre-slot-correction version.
...
At4.815W, the final carrier rerun produces C206-region maxima131.595/124.104/119.713/116.359°C for96/120/140/160µm ideal continuous copper. The slot reinforcement raises the evaluated maxima by at most0.0106K; this small change is explicitly included. The first sampled sheet condition leaving an allocated3K for capacitor/body rise remains140µm, equivalent0.04236W/K per square under the stated conductivity model. It leaves2.287K, corresponding to0.881K/W additional local module-path resistance;160µm leaves5.641K or2.173K/W. These inverse budgets expose why unmodeled interlayer/package resistance cannot be ignored. No guaranteed temperature pass is declared.
