...
def model(step,cu_um,eps,chassis,ambient=65,Pscale=1,direct_R=None,landing_C=65):
 ...
 direct=overlap(box(66.6,11.8,72,28.8))
...
if __name__=='__main__':
 results=[]
 for cu in [96,120,140,160]:
  results.append(model(.5,cu,.3,True,Pscale=4.815/4.79,direct_R=10,landing_C=70))
 r={'status':'EXPLORATORY_SOURCE_POSITION_SENSITIVITY_NOT_NATIVE_THERMAL_PROOF','contact_mm':[66.6,11.8,72,28.8],'total_contact_R_design_K_W':10,'cases':results}
 (D/'THERMAL_CONTACT_T01_MODEL.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(results))
